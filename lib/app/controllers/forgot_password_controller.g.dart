...
mixin _$ForgotPasswordController on _ForgotPasswordController, Store {
  final _$emailAtom = Atom(name: '_ForgotPasswordController.email');
  ...
  final _$isValidEmailAtom =
      Atom(name: '_ForgotPasswordController.isValidEmail');
  ...
  final _$onLoadingAtom = Atom(name: '_ForgotPasswordController.onLoading');
  ...
  final _$emailExistsAtom = Atom(name: '_ForgotPasswordController.emailExists');
  ...
  final _$verifyCodeAtom = Atom(name: '_ForgotPasswordController.verifyCode');
  ...
  final _$isValidCodeAtom = Atom(name: '_ForgotPasswordController.isValidCode');
  ...
  final _$confirmPasswordAtom =
      Atom(name: '_ForgotPasswordController.confirmPassword');
  ...
  final _$errorTextAtom = Atom(name: '_ForgotPasswordController.errorText');
  ...
  final _$passwordChangedAtom =
      Atom(name: '_ForgotPasswordController.passwordChanged');
